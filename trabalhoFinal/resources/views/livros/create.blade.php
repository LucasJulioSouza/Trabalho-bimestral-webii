...
@section('titulo') Livro @endsection
        ...
        <div class="row">
            <div class="col" >
                <div class="form-floating mb-3">
                    <input 
                        type="text" 
                        class="form-control {{ $errors->has('autor') ? 'is-invalid' : '' }} " 
                        name="autor" 
                        placeholder="Autor"
                        value="{{old('autor')}}"
        ...
        <div class="row">
            <div class="col" >
                <div class="form-floating mb-3">
                    <input 
                        type="text" 
                        class="form-control {{ $errors->has('conteudo') ? 'is-invalid' : '' }} " 
                        name="conteudo" 
                    ...
                    <label for="nome">Conteudo do livro</label>
                </div>
            </div>
        </div>
        <div class="row">
