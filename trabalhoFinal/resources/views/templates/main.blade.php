...
<head>
    ...
    <title>Gerenciamento Escolar - @yield('titulo')</title>
...
<body>
    <nav class="navbar sticky-top navbar-expand-md navbar-dark bg-secondary">
        <div class="container-fluid">
            <a href="{{route('index.index')}}" class="navbar-brand ms-sm-3">
                ...
                <span class="ms-3 fs-5">Gerenciamento Escolar</span>
            </a>
            ...
            <div class="collapse navbar-collapse" id="itens">
                <ul class="navbar-nav ms-auto">
                    <li class="nav-item ps-2 me-3">
                        <a class="nav-link" href="{{route('docencias.index')}}">
                            ...
                            <span class="ps-1 text-white">Vincular</span>
                        </a>
                    </li>
    ...
    <nav class="navbar fixed-bottom navbar-dark bg-secondary">
        <div class="container-fluid">Lucas Julio de Souza</span>
        </div>
    </nav>
</body>
...
<script type="text/javascript">
    function showInfoModal(array) {
        $('#infoModal').modal().find('.modal-body').html("");

        // Usando foreach:
        // array.forEach(element => {
        //     $('#infoModal').modal().find('.modal-body').append("<b>" + element + "</b><br>");
        // });


        // Usando for:
        for (let a = 0; a < array.length; a++) {
            $('#infoModal').modal().find('.modal-body').append(array[a]);
        }
